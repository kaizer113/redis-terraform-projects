...
module "region1" {
  ...
  node_instance_types = var.region1_eks_node_instance_types != null ? var.region1_eks_node_instance_types : var.eks_node_instance_types
  node_desired_size   = var.region1_eks_node_desired_count != null ? var.region1_eks_node_desired_count : var.eks_node_desired_count
  node_min_size       = var.region1_eks_node_min_count != null ? var.region1_eks_node_min_count : var.eks_node_min_count
  node_max_size       = var.region1_eks_node_max_count != null ? var.region1_eks_node_max_count : var.eks_node_max_count
  node_disk_size      = var.region1_eks_node_disk_size != null ? var.region1_eks_node_disk_size : var.eks_node_disk_size
...
module "region2" {
  ...
  # EKS Configuration
  kubernetes_version  = var.eks_cluster_version
  node_instance_types = var.region2_eks_node_instance_types != null ? var.region2_eks_node_instance_types : var.eks_node_instance_types
  node_desired_size   = var.region2_eks_node_desired_count != null ? var.region2_eks_node_desired_count : var.eks_node_desired_count
  node_min_size       = var.region2_eks_node_min_count != null ? var.region2_eks_node_min_count : var.eks_node_min_count
  node_max_size       = var.region2_eks_node_max_count != null ? var.region2_eks_node_max_count : var.eks_node_max_count
  node_disk_size      = var.region2_eks_node_disk_size != null ? var.region2_eks_node_disk_size : var.eks_node_disk_size
...
export CRDB_MEMORY="${var.crdb_memory}"
export CRDB_SHARDS="${var.crdb_shards}"
...
export REGION1_DB_SUFFIX="-region1.$${INGRESS_DOMAIN}"
export REGION2_DB_SUFFIX="-region2.$${INGRESS_DOMAIN}"
